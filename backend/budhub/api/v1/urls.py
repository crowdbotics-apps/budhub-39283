...
from .viewsets import AssetsViewSet,CompanyViewSet,Company_typeViewSet,CustomersViewSet,InventoryViewSet,OrdersViewSet,Product_catalogViewSet,Product_typesViewSet,ProductsViewSet
