...
const BlankScreen18090 = () => {
  return <View style={_styles.BlankScreen18090}>
      <ImageBackground style={_styles.sRugyXbB} source={{
    ...
    }} resizeMode="cover"></ImageBackground><TextInput style={_styles.ozzYcLUA} editable={true} placeholder="Username"></TextInput><TextInput style={_styles.epWbYQnz} placeholder="Password"></TextInput><View style={_styles.TXwJuQnU}></View></View>;
};

export default BlankScreen18090;
